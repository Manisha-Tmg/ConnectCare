...
from .serializers import CaretakerSerializer,BookingSerializer,LoginSerializer,CaretakerChangePasswordSerializer,CaretakerProfileSerializer
...
class ProfileEdit(APIView):
    ...
    def patch(self, request, caretaker_id):
        try:
            caretaker = Caretaker.objects.get(id=caretaker_id)
        except Caretaker.DoesNotExist:
            return Response({
        ...
        # if request.caretaker != request.caretaker:
        #     return Response({
        #         "message": 'Caretaker not authorized',
        #         "success": False
        #     }, status=status.HTTP_401_UNAUTHORIZED)

        serializer = CaretakerProfileSerializer(caretaker, data=request.data, partial=True)
        ...
        return Response({
            'message': "Profile edit was unsuccessful",
            "success": False,
